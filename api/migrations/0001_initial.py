# Generated by Django 4.1.2 on 2023-05-24 22:22

import api.models.device_academics
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AccessPeriodModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.IntegerField()),
                ('time_intervals', djongo.models.fields.ArrayField(model_container=api.models.device_academics.TimeIntervalDefinition, model_form_class=api.models.device_academics.TimeIntervalForm)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('access_period', djongo.models.fields.ArrayField(model_container=api.models.device_academics.AccessPeriodDefinition, model_form_class=api.models.device_academics.AccessPeriodForm)),
