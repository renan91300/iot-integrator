...
class DeviceAcademicsModel(BaseModel):
    device = models.ForeignKey(DeviceModel, on_delete=models.CASCADE, verbose_name="Dispositivo")
    academic = models.ForeignKey(AcademicModel, on_delete=models.PROTECT, verbose_name="Acadêmico")
